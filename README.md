...
[![invariants 65](https://img.shields.io/badge/invariants-65-6E4AFF)](SPEC.md)
...
truth — 65 invariants, each carrying the reasoning it stands on; 22 recorded
bugs, each naming the invariant that now catches it; and a task list that says
what is decided and what is still open, at 30 landed and 10 remaining.
