...
[![invariants 66](https://img.shields.io/badge/invariants-66-6E4AFF)](SPEC.md)
[![bugs logged 23](https://img.shields.io/badge/bugs_logged-23-6E4AFF)](SPEC.md)
...
truth — 66 invariants, each carrying the reasoning it stands on; 23 recorded
bugs, each naming the invariant that now catches it; and a task list that says
what is decided and what is still open, at 31 landed and 10 remaining.
