...
[![invariants 64](https://img.shields.io/badge/invariants-64-6E4AFF)](SPEC.md)
...
truth — 64 invariants, each carrying the reasoning it stands on; 21 recorded
bugs, each naming the invariant that now catches it; and a task list that says
what is decided and what is still open, at 29 landed and 10 remaining.
