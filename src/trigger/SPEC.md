...
the fenced `rekall` BLOCK: its keys, how they combine, and the refusal clause that wins.
...
self|src/trigger|the fenced `rekall` BLOCK: its keys, how they combine, and the refusal clause that wins.
