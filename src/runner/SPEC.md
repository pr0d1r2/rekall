...
EXECUTING a rule's script under a CPU bound, and reporting what it said.
...
self|src/runner|EXECUTING a rule's script under a CPU bound, and reporting what it said.
