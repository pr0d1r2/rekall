...
THE COLD START: detecting roots and writing a project config without clobbering one.
...
self|src/init|THE COLD START: detecting roots and writing a project config without clobbering one.
