...
THE STORE: extracted rows, candidate rows, fire counts, and prefix lookup.
...
self|src/ledger|THE STORE: extracted rows, candidate rows, fire counts, and prefix lookup.
