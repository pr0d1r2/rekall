...
REACHING the files: roots x globs, the walk, symlink loops, and what could not be read.
...
self|src/corpus|REACHING the files: roots x globs, the walk, symlink loops, and what could not be read.
